  ...
  return (
    <div className="hover:bg-slate-900 hover:border-slate-600 border max-md:h-36  h-40 p-2 flex gap-5 w-full rounded-md ">
      ...
      <div className="w-full  py-3  ">
        ...
        <span className="w-fit  border-sky-600 rounded-full flex px-2 items-center  bg-sky-900 ">{series.genres[0] } </span>
        <span className="w-1 h-1 text-md bg-slate-50 rounded-full self-center mx-1"></span>

        <span className="w-fit bg-fuchsia-900 border border-fuchsia-600 rounded-full flex px-2 items-center  ">{series.views>1000? series.views/1000+"k":series.views } <Eye className="w-3 h-3 ml-2"/></span>
        <span className="w-1 h-1 text-md bg-slate-50 rounded-full self-center mx-1"></span>
